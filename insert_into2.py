...
sql_query ="select `ExamID`,`itempid`,`userAnswer`,`userScore`,`correct_answer`,`item_type`,`item_sort`,`istrue`,`link_ExamID`,`num`,`status`,`isdel`,`pdid`,`student_id`,`topic_type`,`topic_sort`,`modifydate` from gd_paper_data_best_item where id <= 650000 and id > 450000"
