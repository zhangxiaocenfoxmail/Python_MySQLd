...
sql_query ="select `ExamID`,`itempid`,`userAnswer`,`userScore`,`correct_answer`,`item_type`,`item_sort`,`istrue`,`link_ExamID`,`num`,`status`,`isdel`,`pdid`,`student_id`,`topic_type`,`topic_sort`,`modifydate` from gd_paper_data_best_item where id <= 2250000 and id > 2050000"
...
buff = Buffer(conn_store, "insert into gd_paper_data_best_item(`ExamID`,`itempid`,`userAnswer`,`userScore`,`correct_answer`,`item_type`,`item_sort`,`istrue`,`link_ExamID`,`num`,`status`,`isdel`,`pdid`,`student_id`,`topic_type`,`topic_sort`,`modifydate`)  values (%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s)")
sql_query = {'charset': 'utf8'}
sql_query ="select `ExamID`,`itempid`,`userAnswer`,`userScore`,`correct_answer`,`item_type`,`item_sort`,`istrue`,`link_ExamID`,`num`,`status`,`isdel`,`pdid`,`student_id`,`topic_type`,`topic_sort`,`modifydate` from gd_paper_data_best_item where  id > 2250000"
curr_src = conn_src.cursor()
curr_src.execute(sql_query)
for row in curr_src:
    buff.append(row)
